...
test("separate cross-source payments with verified distant times stay separate",()=>{const existing={amount_paise:45000,merchant:"Cafe Coffee Day",occurred_at:"2026-08-05T09:00:00Z",time_verified:1,account_tag:"Paytm",source:"paytm_pdf"};const incoming={amountPaise:45000,merchant:"Cafe Coffee Day",occurredAt:"2026-08-05T18:00:00Z",timeVerified:true,accountTag:"ICICI",description:"Cafe Coffee Day"};assert.equal(duplicateEvidence(existing,incoming,"bank_pdf"),null);});
test("cross-source records with verified close timestamps are merged",()=>{const existing={amount_paise:45000,merchant:"Cafe Coffee Day",occurred_at:"2026-08-05T09:00:00Z",time_verified:1,account_tag:"Paytm",source:"paytm_pdf"};const incoming={amountPaise:45000,merchant:"Cafe Coffee Day",occurredAt:"2026-08-05T09:03:00Z",timeVerified:true,accountTag:"ICICI",description:"Cafe Coffee Day"};assert.equal(duplicateEvidence(existing,incoming,"bank_pdf"),"cross-source-time");});
